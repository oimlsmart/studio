...
The repository is [`primmel/editor`](https://github.com/primmel/editor); the full manual is its [user guide](https://github.com/primmel/editor/tree/main/docs) (audience-organized, with diagrams for every surface). The architecture chapter is [21, Primmel Studio](https://www.oimlsmart.org/docs/arch/21-primmel-studio).
...
Pair it with the [r60 classroom](https://github.com/oimlsmart/smart-r60): r60 teaches the methodology (six levels, live twin); the R 7 tutorial proves you can apply it to a document you have never modelled. The federation volume carries the full story at [Tier 5, the dual demo](https://www.primmel.org/primmel-smart-docs/learn/05-the-dual-demo/).
